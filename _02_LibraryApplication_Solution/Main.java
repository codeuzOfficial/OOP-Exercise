...
public class Main {
    ...
    private static boolean addBookTest() {
        ...
        if (!test1) {
            System.err.println("addBookTest: test1 Hatolik");
            return false;
        }
        ...
        if (!test2) {
            System.err.println("addBookTest: test2 Hatolik");
            return false;
        }
        return true;
    }
    ...
    private static boolean containsTest() {
        ...
        if (!test1) {
            System.err.println("containsTest test1 Hatolik");
            return false;
        }

        boolean test2 = library.contains(1, "C1", 1, new Book("a", "t"));
        if (test2) {
            System.err.println("containsTest test2 Hatolik");
            return false;
        }

        boolean test3 = library.contains(1, "C1", 1, new Book("author 1", "title 1"));
        if (!test3) {
            System.err.println("containsTest test3 Hatolik");
            return false;
        }
    ...
    private static boolean getBooksTest() {
        ...
        if (!test1.contains("Shelf 0\n" +
                ...
                "Shelf 4\n" +
                "Shelf 5\n")) {
            System.err.println("getBooksTest test1 Hatolik");
            return false;
        }
        ...
        if (!test2.contains("Shelf 0\n" +
                ...
                "Shelf 4\n" +
                "Shelf 5\n")) {
            System.err.println("getBooksTest test2 Hatolik");
            return false;
        }
        return true;
    }

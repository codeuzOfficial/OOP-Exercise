...
public class Main {
    ...
    private static boolean talab_4() {
        ...
        if (!doctorsByNumPatientList.get(0).equals("2: 892 Chang chun Jumong")) {
            System.err.println("talab_4 -> test3:  ro'yhat boshida '2: 892 Chang chun Jumong'  bo'lishi kerak  ERROR");
            return false;
        }

        if (!doctorsByNumPatientList.get(2).equals("0: 5329 Afandi Afandi")) {
        ...
        if (countPatientsPerSpecializations == null || countPatientsPerSpecializations.size() != 4) {
            System.err.println("talab_4 -> test4:  ro'yhatda 4 ta shifokor bo'lishi kerak  ERROR");
            return false;
        }
        ...
        if (!countPatientsPerSpecializationList.get(0).equals("2 - Lo'r")) {
            System.err.println("talab_4 -> test4:  ro'yhat boshida '2 - Lo'r'  bo'lishi kerak  ERROR");
            return false;
        }

        if (!countPatientsPerSpecializationList.get(2).equals("0 - Tish shifokori")) {
            System.err.println("talab_4 -> test4:  ro'yhatda 2-chi index da  '0 - Tish shifokori'  bo'lishi kerak  ERROR");
            return false;
        }
